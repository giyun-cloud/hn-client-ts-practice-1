...
var NewsFeedApi = function () {
  ...
  NewsFeedApi.prototype.getData = function (url) {
...
var NewsDetailApi = function () {
  ...
  NewsDetailApi.prototype.getData = function (url) {
    return this.getRequest(url);
  };
...
var NewsFeedView = function (_super) {
  ...
  function NewsFeedView(containerId) {
    ...
    if (_this.feeds.length === 0) {
      _this.feeds = store.feeds = _this.api.getData(NEWS_URL);
  ...
  NewsFeedView.prototype.render = function () {
    ...
    this.setTemplateData("next_page", String(store.currentPage < this.feeds.length / 10 ? store.currentPage + 1 : Math.ceil(this.feeds.length / 10)));
    this.updateView();
  };
...
var NewsDetailView = function (_super) {
  ...
  NewsDetailView.prototype.render = function () {
    ...
    var newsContent = api.getData(CONTENT_URL.replace("@id", id));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14607" + '/');
...
},{}]},{},["C:/Users/skack/AppData/Roaming/nvm/v12.14.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
